...
@section('page-title', 'Chỉnh sửa danh mục tin')
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('news_categories.update', $newsCategory->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="slug" name="slug" value="{{ old('slug',  $newsCategory->slug) }}">
                                @if ($errors->has('slug'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="sort_order" name="sort_order" 
                                       value="{{ old('sort_order', $newsCategory->sort_order) }}">
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="is_show_menu" name="is_show_menu" 
                                           {{ $newsCategory->is_show_menu == 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="is_show_home" name="is_show_home" 
                                           {{ $newsCategory->is_show_home == 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title_seo" name="title_seo" 
                                       value="{{ old('title_seo', $newsCategory->title_seo) }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="description_seo" name="description_seo" rows="3">{{ old('description_seo', $newsCategory->description_seo) }}</textarea>

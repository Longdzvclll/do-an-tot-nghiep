...
<head>
    ...
    <link rel="dns-prefetch" href="{{ url()->current() }}">
    ...
    <meta property="og:title" content="@yield('og:title', config('app.name', 'Food'))">
    <meta property="og:description" content="@yield('og:description', config('app.description', 'Ẩm thực'))">
    ...
    <meta property="twitter:url" content="@yield('twitter:url', url()->current())">
    <meta property="twitter:title" content="@yield('twitter:title', config('app.name', 'Food'))">
    <meta property="twitter:description" content="@yield('twitter:description', config('app.description', 'Ẩm thực'))">
    <meta property="twitter:image" content="@yield('twitter:image', asset('images/logo.png'))">
...
<head>
    ...
    <link href='{{asset("assets/frontend/css/styles.css")}}' rel='stylesheet' type='text/css'
          media='all'/>
    <script src='{{asset("assets/frontend/js/jquery.min.1.11.0.js")}}'
    ...
    <meta property="og:site_name" content="lacfoods.vn"/>
...
<body id="chiken-theme" class="index">
<div class="main-body  layoutProduct_scroll ">
    ...
    <div class="addThis_listSharing hidden-sm hidden-xs">
        <ul class="addThis_listing">
            ...
            <li class="addThis_item">
                <a class="addThis_item--icon" href="//zalo.me/0369429883" target="_blank" rel="nofollow noreferrer"
                   aria-label="zalo">
                    <svg viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {{-- <div class="actionToolbar_mobile hidden ">
        <ul class="actionToolbar_listing">
            ...
            <li>
                <a href="//zalo.me/0369429883" target="_blank" rel="nofollow noreferrer" aria-label="zalo">
...
<script>
    ...
    $('.pro-btn-order').on('click', function(event) {
        event.preventDefault();

        // Lấy product_id và số lượng từ thuộc tính data của nút
        let productId = $(this).data('product_id');
        let quantity = $(this).data('quantity') || 1; // Mặc định số lượng là 1 nếu không được chỉ định
...
<script>
  const tudong_chatbox = new TuDongChat('bGKhigRo4aXkOt5Sh-V2g')
